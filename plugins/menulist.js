 ...
 if (teks == 'nsfw') tags = {
  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    {title: `📛)ഒ Info Bot`, rowId: ".info", description: "✧ Info nya Tighnari BOT ><"},
	...
	{title: `💻)ഒ Bot Stats`, rowId: ".botinfo", description: "✧ Menampilkan Status 赤 Tighnari - BOT"},
	{title: `📊)ഒ Test Speed`, rowId: ".testspeed", description: "✧ Test Install Speed BOT"},
	{title: `⚡)ഒ Speed`, rowId: ".speed", description: "✧ Kecepatan Respon 赤 Tighnari - BOT..."},
	]
    },{
	...
	title: `${htki} ▮ᴍᴇɴᴜ ᴛɪɢʜɴᴀʀɪ ʙᴏᴛ  ${htka}`,
	rows: [
	...
	title: `${htki} ▮ɪɴғᴏ ᴛɪɢʜɴᴀʀɪ ʙᴏᴛ  」 ${htka}`,
	rows: [
...
let tek = `
  ...
  - Hai Namaku Tighnari BOT Di Buat Oleh Uzui Michelle
  - Silahkan Pilih Menu Nya (⁠^⁠.⁠_⁠.⁠^⁠)⁠ﾉ
...
const listMessage = {
  text: tek,
  footer: '© TIGHNARI BOTZ | ALL RESERVED',
...
*/
	...
	return conn.sendButton(m.chat, text, wm, img2, [["🥞MENU", _p + "menu"], ["🌸SCRIPT", _p + "sc"]], m, {
        contextInfo: {
            externalAdReply: {
                mediaUrl: "https://chat.whatsapp.com/BpuUbEx8niML0pmEqkbp8L",
                mediaType: "VIDEO",
                title: '꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦ ͝ ꒷ ͝ ꒦',
                body: 'Source Code By Uzui Michelle',
                previewType: 0,
                thumbnail: img
            }
        }
...
//-------DOC TEMPLATE
    const message = {
            ...
            pageCount: fpagedoc,
            caption: text,
            footer: titlebot + '\n⚡ Supported By Uzui Michelle TEAM',
            templateButtons: [
                {
                    urlButton: {
                        displayText: `${namebot}`,
                        url: 'https://chat.whatsapp.com/GObfv1nqaVLDSJSNh0eDJ4'
                    }
                },
                {
                    urlButton: {
